...
from main import app, get_db #get_db faz conexão com  banco
...
def test_listar_produtos_com_mock():
    ...
    app.dependency_overrides[get_db] = lambda: db_mock #mock é tipo o figma de funcionalidade
    ...
    app.dependency_overrides.clear() #os testes vão rodar em memória, então é preciso que memoria seja liberada pra cada teste (essa linha faz isso)
